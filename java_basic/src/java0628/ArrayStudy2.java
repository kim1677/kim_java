...
public class ArrayStudy2 {
	...
	public static void main(String[] args) {
		...
		// 문제.1
		// 과자 배열에 좋아하는 과자의 판매가격을 키보드로 입력하여 저장하시오
		// 과자 배열에 저장된 판매가격들의 총합과 평균을 구하시오
		
		// 배열 인덱스 정하기
//		int[] 과자 = new int[5];
//
//	    // 과자 배열에 좋아하는 과자의 판매가격을 키보드로 입력받아 저장합니다.
//	    for (int i = 0; i < 과자.length; i++) {
//	    	System.out.print("과자 " + (i + 1) + "의 가격을 입력하세요: ");
//	    	과자[i] = scanner.nextInt();
//	    }
//
//	    // 총합을 구합니다.
//	    int total = 0, avg =0;
...
//
//	    // 결과를 출력합니다.
//	    System.out.println("과자 가격의 총합: " + total);
//	    System.out.println("과자 가격의 평균: " + avg);
...
//		
//		// 키가 175 미만인 값을 출력합니다.
//        System.out.println("키가 175 미만인 값들:");
...
//        
//        // 문자열에서 특정 문자나 문자열의 위치찾기 - indwxOf
//        System.out.println(word.indexOf("like")	);				// 인덱스 위치 확인
//        
...
//        a[0].indexOf("na");	//2
//        
//        a[1].indexOf("ga");	// true		"orange" 문자열에 들어있으니까 true
...
//        }
        ...
        String[] 카페 = new String[] {
        		"아메리카노 : 2000원", "화이트아메리카노 : 2800원",
        		"카페라떼 : 3000원", "돌체라떼 : 3000원",
